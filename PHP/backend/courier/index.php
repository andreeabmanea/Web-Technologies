...
<div class="middle-box">
    <div class="starter">
        <p class="title">Hello, <?php echo $_SESSION['username'];?>. Here is today's schedule:</p>
    ...
    <div class="starter">
        <p class="title">Enter AWB:</p>
        <div class="courier-awb">
            <form method = "post">
            <input type="text" placeholder="AWB" id="fawb" name="fawb">
            <a class="button" onclick="markAsDoneSubmit()" id = "delivery_done">Mark as done</a>
...
<div id="ask-for-support" class="modal">
    <div class="modal-content">
        <p class="title">Enter your request:</p>
        <div class="container">
            ...
            <a class="button close" style="margin-left:44%" onclick="askForSupport(); document.getElementById('ask-for-support').style.display='none';" title="Close">Confirm</a>
        </div>
    </div>
</div>
<?php
