...
<script>
    ...
    function getOperators() {
        ...
        xhttp.open("GET", "find_accounts.php?role=operator", true);
        xhttp.send();
    }
    ...
    function getCouriers() {
        ...
        xhttp.open("GET", "find_accounts.php?role=courier", true);
        xhttp.send();
    }
    ...
    function getClients() {
        ...
        xhttp.open("GET", "find_accounts.php?role=client", true);
        xhttp.send();
    }
    ...
    function removeAccount(id) {
        ...
        xhttp.open("POST", "remove_account.php", true);
    ...
    function detailsAccount(id) {
        ...
        xhttp.open("GET", "details_account.php?id=" + id, true);
        xhttp.send();
    }
    ...
    async function getOrdersByArea() {
        try {
            let res = await fetch("get_orders_by_area.php");
    ...
    async function getOrdersByMonth() {
        try {
            let resMonth = await fetch("get_orders_by_month.php");
